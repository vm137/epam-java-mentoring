insert into cdp.public.students (code, first, last, primary_skill)
values (101, 'John', 'Dow', 'programmer'),
...
insert into cdp.public.subjects (code, title, tutor, hours)
values (108, 'Mathematics', 'Rene Descartes', 100),
...
insert into exam_results (student_code, subject_code, mark)
values (101, 108, 2),
       (101, 205, 3),
       (101, 107, 1),
       (102, 404, 5),
